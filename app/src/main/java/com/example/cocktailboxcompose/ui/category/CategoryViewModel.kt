package com.example.cocktailboxcompose.ui.category
...
class CategoryViewModel @Inject constructor(
    ...
    enum class ClassicState {
        ERROR_CONNECTION,
        ERROR_SERVER
    }

    private val _messageSharedFlow = MutableSharedFlow<ClassicState>()
    ...
    private fun fetchDrinksByCategoryAll() {
        viewModelScope.launch {
            try {
                ...
                currentState = ClassicState.ERROR_CONNECTION
            }
